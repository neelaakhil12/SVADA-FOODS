...
export default function ShippingPolicy() {
  const clauses = [
    ...
    "In the event of transit damage, customers must report the issue within 48 hours of delivery along with supporting photographs or videos.",
    "If any product is missing from the order, customers must notify SVADA FOODS within 48 hours of receiving the shipment.",
